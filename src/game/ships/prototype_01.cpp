        ...
        .handling =
            {
                ...
                .world_traction_risk_start_speed_fraction = 0.75F,
                .world_high_speed_grip_multiplier = 0.45F,
                .world_sustained_slip_grip_multiplier = 0.55F,
                .world_lift_off_grip_multiplier = 1.50F,
                .world_braking_grip_multiplier = 1.80F,
                ...
                .world_gravity_acceleration_metres_per_second_squared = 30.0F,
                .world_hover_spring_per_second_squared = 180.0F,
                .world_hover_damping_per_second = 27.0F,
                .world_maximum_hover_acceleration_metres_per_second_squared = 120.0F,
                .world_support_detach_height_metres = 0.75F,
                .world_support_landing_height_metres = 0.25F,
                .world_takeoff_normal_speed_metres_per_second = 5.0F,
                .world_supported_up_response_per_second = 10.0F,
                .world_airborne_gravity_up_response_per_second = 1.5F,
                .world_wall_restitution = 0.15F,
                .world_wall_tangent_retention = 0.85F,
                .world_recovery_delay_seconds = 1.25F,
                .world_recovery_drop_metres = 20.0F,
                .world_recovery_speed_fraction = 0.25F,
                .world_recovery_safe_margin_metres = 1.0F,
